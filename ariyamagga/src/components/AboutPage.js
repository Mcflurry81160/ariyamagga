...
function AboutPage() {
    return (
        <div className="container">
            <h3>Welcome to Ariyamagga Senasuna test1</h3>
            ...
            <p>The atmosphere is a blend of a traditional village temple and an Aranya and its air is conducive to village folks seeking to fulfill their worldly needs whilst  providing necessary counseling to strengthen the much needed skills(Parami )to traverse the path. Aged and sick monks receive lifelong care by volunteering village folks. There are four dedicated rooms (kutis)with two attached toilets for the sick and infirm. They provide the necessary seclusion for meditating Bhikkhus.</p>
        </div>
    );
}
