  ...
  render() {
    ...
    const ChethiyaProject = () => {
      return (<div>
        ...
        <div className="project-sub-title">Download brochure <a target="_blank" href="https://ariyamaggasenasuna.blob.core.windows.net/project-001-chethiya/chethiya-brochure.pdf">here</a></div>
      </div>);
    }
